  ...
  return (
    <main className="page">
      <header className="header">
        <div className="pill">Vault 3.0</div>
        <h1 className="title">ICL Vault</h1>
        <p className="subtitle">
          Clinical decision support for ICL lens size and post-operative vault.
        </p>
      </header>
      ...
      <div className="grid">
        <section className="card">
          ...
          <button className="button" onClick={handlePredict} disabled={status === "loading"}>
        ...
        <section className="card">
          ...
          {!result && (
            <p>Enter patient measurements and click Calculate.</p>
          )}
          {result && (
            <>
              <div>
