...
def extract_all_features():
    ...
    for xml_file in xml_files:
        ...
        # Merge CSV data (only SEQ, Vault, Lens_Size)
    ...
    feature_cols_check = ['Age', 'WTW', 'ACD_internal', 'ACV', 'ACA_global', 'Pupil_diameter', 
    ...
    feature_cols = ['Age', 'WTW', 'ACD_internal', 'ACV', 'ACA_global', 'Pupil_diameter', 
                    'AC_shape_ratio', 'TCRP_Km', 'TCRP_Astigmatism', 'SEQ', 
                    'SimK_steep', 'CCT', 'BAD_D']
    ...
    if incomplete.sum() > 0:
        flagged_file = "flagged_incomplete_cases.csv"
